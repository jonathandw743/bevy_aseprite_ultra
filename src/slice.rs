...
use bevy::{ecs::system::ScheduleSystem, prelude::*, sprite::Anchor};
...
pub trait AddSliceRenderSystem {
    fn add_slice_render_system<M>(&mut self, systems: impl IntoScheduleConfigs<ScheduleSystem, M>) -> &mut Self;
}
